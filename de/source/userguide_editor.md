...
[![](_images/ug_e_login.png)](_images/ug_e_login.png)
...
[![](_images/ug_e_vocabularyempty.png)](_images/ug_e_vocabularyempty.png)
...
[![](_images/ug_e_vocabularyfull.png)](_images/ug_e_vocabularyfull.png)
...
[![](_images/ug_e_newvocab1.png)](_images/ug_e_newvocab1.png)

Nach erfolgreicher Erstellung öffnet sich eine Übersicht der Konzepte des Vokabulars. Diese ist zur Zeit (noch) leer.

[![](_images/ug_e_newvocabemptyconcepts.PNG)](_images/ug_e_newvocabemptyconcepts.PNG)
...
[![](_images/ug_e_vocabularyedit1.PNG)](_images/ug_e_vocabularyedit1.PNG)
...
[![](_images/ug_e_vocabularyedit2.PNG)](_images/ug_e_vocabularyedit2.PNG)

Zum löschen oder publizieren ist eine erneute Bestätigung nötig:

[![](_images/ug_e_vocabularyedit3.PNG)](_images/ug_e_vocabularyedit3.PNG)

[![](_images/ug_e_vocabularyedit4.PNG)](_images/ug_e_vocabularyedit4.PNG)
...
[![](_images/ug_e_vocabularyedit5.PNG)](_images/ug_e_vocabularyedit5.PNG)

Zudem können Referenz Vokabulare eingestellt werden, welche ebenfalls zur Verknüpfung im Konzept-Detail dienen.

[![](_images/ug_e_vocabularyedit6.PNG)](_images/ug_e_vocabularyedit6.PNG)
...
[![](_images/ug_e_conceptfull.png)](_images/ug_e_conceptfull.png)
...
[![](_images/ug_e_conceptsortextend.PNG)](_images/ug_e_conceptsortextend.PNG)
...
[![](_images/ug_e_newconcept1.PNG)](_images/ug_e_newconcept1.PNG)
...
[![](_images/ug_e_newconcept2.PNG)](_images/ug_e_newconcept2.PNG)
...
[![](_images/ug_e_conceptsaftercreate.PNG)](_images/ug_e_conceptsaftercreate.PNG)

Durch Klick auf das Konzept kann zur (noch) leeren [Konzept-Detail-Übersicht](#konzept-detail) gesprungen werden.

[![](_images/ug_e_conceptdetailempty.PNG)](_images/ug_e_conceptdetailempty.PNG)
...
[![](_images/ug_e_conceptdetailsections1.PNG)](_images/ug_e_conceptdetailsections1.PNG)
...
[![](_images/ug_e_conceptproperties.PNG)](_images/ug_e_conceptproperties.PNG)
...
[![](_images/ug_e_conceptpreview_big.png)](_images/ug_e_conceptpreview_big.png)

[![](_images/ug_e_conceptpreview_small.png)](_images/ug_e_conceptpreview_small.png)
...
[![](_images/ug_e_csvexample2.png)](_images/ug_e_csvexample2.png)

[![](_images/ug_e_csvexample.png)](_images/ug_e_csvexample.png)
...
[![](_images/ug_e_adddescription.png)](_images/ug_e_adddescription.png)
...
[![](_images/ug_e_concept_eb_description.PNG)](_images/ug_e_concept_eb_description.PNG)

Nach erfolgreicher Speicherung wird die Beschreibung unter der Sektion `Descriptive` angezeigt.

[![](_images/ug_e_concept_eb_description2.PNG)](_images/ug_e_concept_eb_description2.PNG)
...
[![](_images/ug_e_concept_eb_description3.PNG)](_images/ug_e_concept_eb_description3.PNG)
...
[![](_images/ug_e_addtranslation.png)](_images/ug_e_addtranslation.png)
...
[![](_images/ug_e_concept_eb_translation.PNG)](_images/ug_e_concept_eb_translation.PNG)

Nach erfolgreicher Speicherung wird die Übersetzung unter Angabe der Sprache unter der Sektion `Descriptive` angezeigt.

[![](_images/ug_e_concept_eb_translation2.PNG)](_images/ug_e_concept_eb_translation2.PNG)
...
[![](_images/ug_e_concept_eb_translation3.PNG)](_images/ug_e_concept_eb_translation3.PNG)
...
[![](_images/ug_e_addwayback.png)](_images/ug_e_addwayback.png)

Ein Klick auf `Add link to wayback Ressource` offnet einen Dialog, der zur Eingabe einer URL auffordert.

[![](_images/ug_e_concept_eb_wayback.PNG)](_images/ug_e_concept_eb_wayback.PNG)
...
[![](_images/ug_e_concept_eb_wayback2.PNG)](_images/ug_e_concept_eb_wayback2.PNG)
...
[![](_images/ug_e_concept_eb_wayback3.PNG)](_images/ug_e_concept_eb_wayback3.PNG)
...
[![](_images/ug_e_concept_eb_wayback4.PNG)](_images/ug_e_concept_eb_wayback4.PNG)
...
[![](_images/ug_e_concept_eb_search1.PNG)](_images/ug_e_concept_eb_search1.PNG)
...
[![](_images/ug_e_concept_eb_search2.PNG)](_images/ug_e_concept_eb_search2.PNG)
...
[![](_images/ug_e_concept_eb_search3.PNG)](_images/ug_e_concept_eb_search3.PNG)

[![](_images/ug_e_concept_eb_search4.PNG)](_images/ug_e_concept_eb_search4.PNG)
...
[![](_images/ug_e_concept_eb_search5.PNG)](_images/ug_e_concept_eb_search5.PNG)

Nach erfolgreicher Speicherung wird der Link unter der gewählten Sektion angezeigt.

[![](_images/ug_e_concept_eb_search6.PNG)](_images/ug_e_concept_eb_search6.PNG)
...
[![](_images/ug_e_concept_eb_search7.PNG)](_images/ug_e_concept_eb_search7.PNG)
...
[![](_images/ug_e_concept_eb_search8.PNG)](_images/ug_e_concept_eb_search8.PNG)
...
[![](_images/ug_e_concept_eb_search9.PNG)](_images/ug_e_concept_eb_search9.PNG)

[![](_images/ug_e_concept_eb_search10.PNG)](_images/ug_e_concept_eb_search10.PNG)
...
[![](_images/ug_e_concept_eb_search11.PNG)](_images/ug_e_concept_eb_search11.PNG)
...
[![](_images/ug_e_concept_eb_search12.PNG)](_images/ug_e_concept_eb_search12.PNG)

#### Suche in Referenzvokabular

Die Suche in Referenzvokabularen wird durch Klick des rechten Tab im Such-Modul aktiviert.

[![](_images/ug_e_concept_eb_search13.PNG)](_images/ug_e_concept_eb_search13.PNG)
...
[![](_images/ug_e_concept_eb_search14.PNG)](_images/ug_e_concept_eb_search14.PNG)
